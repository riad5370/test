            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-md-6 col-6 col-xs-6">
                        <h4 class="widget-title">Contact Basic Info</h4>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center" style="margin-top: 15px; margin-left: 10px;">
                    <form action="{{route('contact.basic.update')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $contactBasic ? $contactBasic->id : '' }}">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="title">Title :</label>

                        <div class="col-sm-9">
                            <input type="text" value="{{ $contactBasic ? $contactBasic->title : '' }}" name="title" id="title" placeholder="title"
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="image">Slide Image  :</label>
                        <div class="col-sm-9">
                            <div class="col-sm-5">
                            ...
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <img height="145" id="blah" width="155" src="{{ asset('images/contactBasic/'.($contactBasic->image??'')) }}"
                                        alt="Image">
                                </label>
                            </span>
                            @error('image')
