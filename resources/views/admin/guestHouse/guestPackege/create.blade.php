...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        <li class="active"><i class="menu-icon fa fa-bed"></i> GuestHouse</li>
        <li>
            <li class="active" style="font-weight: bold;">Packege</li>
        </li>
        <li class="active"><a href="{{route('guesthousepackege.index')}}">Go Packege List</a></li>
    </ul>
</div>
    @if ($errors->any())
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-md-6 col-6 col-xs-6">
                        <h4 class="widget-title">Make GuestHouse Packege</h4>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center" style="margin-top: 15px; margin-left: 10px;">
                    <form action="{{route('guesthousepackege.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                     {{-- Donar name  --}}
